...
void PrintDecodedMachineInstruction(InstructionFields* instructionFieldsPtr)
{
    ...
    if (assemblyMnemonic == LDWI)
    {
        ...
        printf("Opcode:            Hex: 0x%02X         ", instructionFieldsPtr->opcode);
        printf("Binary: ");
        printf(EIGHT_BIT_BYTE_TO_BINARY_PATTERN, EIGHT_BIT_BYTE_TO_BINARY(instructionFieldsPtr->opcode));
        printf("\n");
        ...
        printf("Immediate Value:   Hex: 0x%04hX        ", instructionFieldsPtr->immediate);
        printf("Binary: ");
        printf(SIXTEEN_BIT_BYTE_TO_BINARY_PATTERN, SIXTEEN_BIT_BYTE_TO_BINARY(instructionFieldsPtr->immediate));
        printf("\n");

        printf("\n");
    }

    if (assemblyMnemonic == ADDI)
    {
        char* assemblyRegisterRT_RD = MapMachineRegisterToAssemblyRegister(instructionFieldsPtr->RD_RT);
        ...
        printf("RS1 Register:      Hex: 0x%1X          ", instructionFieldsPtr->RM);
        printf("Binary: ");
    ...
    if (assemblyMnemonic == ADD || assemblyMnemonic == SUB || assemblyMnemonic == MUL || assemblyMnemonic == DIV)
    {
        char* assemblyRegisterRT_RD = MapMachineRegisterToAssemblyRegister(instructionFieldsPtr->RD_RT);
        char* assemblyRegisterRM = MapMachineRegisterToAssemblyRegister(instructionFieldsPtr->RM);
        ...
        printf("RS2 Register:      Hex: 0x%1X          ", instructionFieldsPtr->RN);
        printf("Binary: ");
    ...
    if (assemblyMnemonic == LDW)
    {
        ...
        printf("RB Register:       Hex: 0x%1X          ", instructionFieldsPtr->RM);
        printf("Binary: ");
        printf(FOUR_BIT_NIBBLE_TO_BINARY_PATTERN, FOUR_BIT_NIBBLE_TO_BINARY(instructionFieldsPtr->RM));
        printf("\n");

        printf("Immediate Value:   Hex: 0x%04hhX       ", instructionFieldsPtr->immediate);
        printf("Binary: ");
        printf(SIXTEEN_BIT_BYTE_TO_BINARY_PATTERN, SIXTEEN_BIT_BYTE_TO_BINARY(instructionFieldsPtr->immediate));
        printf("\n");
    ...
    if (assemblyMnemonic == STW)
    {
        ...
        printf("RS Register:       Hex: 0x%1X          ", instructionFieldsPtr->RD_RT);
        printf("Binary: ");
        printf(FOUR_BIT_NIBBLE_TO_BINARY_PATTERN, FOUR_BIT_NIBBLE_TO_BINARY(instructionFieldsPtr->RD_RT));
        printf("\n");
        ...
        || assemblyMnemonic == BG || assemblyMnemonic == BLE || assemblyMnemonic == BGE)
    {
        ...
        printf("RS1 Register:       Hex: 0x%1X          ", instructionFieldsPtr->RD_RT);
        printf("Binary: ");
        printf(FOUR_BIT_NIBBLE_TO_BINARY_PATTERN, FOUR_BIT_NIBBLE_TO_BINARY(instructionFieldsPtr->RD_RT));
        printf("\n");

        printf("RS2 Register:       Hex: 0x%1X          ", instructionFieldsPtr->RM);
        printf("Binary: ");
        printf(FOUR_BIT_NIBBLE_TO_BINARY_PATTERN, FOUR_BIT_NIBBLE_TO_BINARY(instructionFieldsPtr->RM));
        printf("\n");
    ...
    if (assemblyMnemonic == HALT)
    {
        ...
        printf("Padding:           Hex: 0x%06hhX     ", 0);
        printf("Binary: ");
        printf(EIGHT_BIT_BYTE_TO_BINARY_PATTERN, EIGHT_BIT_BYTE_TO_BINARY(0));
        printf(SIXTEEN_BIT_BYTE_TO_BINARY_PATTERN, SIXTEEN_BIT_BYTE_TO_BINARY(0));
        printf("\n");
...
char* MapMachineOpcodeToAssemblyMnemonic(uint8_t machineOpcode)
{
    ...
    if (machineOpcode == OPCODE_LDWI_HEX) assemblyMnemonic = LDWI;
    if (machineOpcode == OPCODE_ADDI_HEX) assemblyMnemonic = ADDI;
    ...
    if (machineOpcode == OPCODE_LDW_HEX) assemblyMnemonic = LDW;
    if (machineOpcode == OPCODE_STW_HEX) assemblyMnemonic = STW;
    ...
    if (machineOpcode == OPCODE_JAL_HEX) assemblyMnemonic = JAL;
    if (machineOpcode == OPCODE_JLR_HEX) assemblyMnemonic = JLR;
