...
//BIT MASKS
#define ALU_OP_ADDI_BITMASK									0x0001
#define ALU_OP_ADDI_BITMASK_BINARY							0b0000000000000001
...
#define BRANCH_AND_LINK_BITMASK								0x4000
#define BRANCH_AND_LINK_BITMASK_BINARY						0b0100000000000000
#define BRANCH_LINK_REGISTER_BITMASK						0x8000
#define BRANCH_LINK_REGISTER_BITMASK_BINARY					0b1000000000000000

#define ALU_OP_ADDI_BIT_SHIFT								0
...
#define PC_SOURCE_BITMASK_BIT_SHIFT							13
#define BRANCH_AND_LINK_BIT_SHIFT							14
#define BRANCH_LINK_REGISTER_BIT_SHIFT						15
...
#define BRANCH_AND_LINK_FLAG_OFF							0
#define BRANCH_AND_LINK_FLAG_ON								1

#define BRANCH_LINK_REGISTER_FLAG_OFF						0
#define BRANCH_LINK_REGISTER_FLAG_ON						1
...
typedef struct
{
	...
	uint8_t branchAndLink;
	uint8_t branchLinkRegister;
