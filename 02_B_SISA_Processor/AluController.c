...
void ALUControllerResetSignals(ALUController* aluControllerPtr)
{
    aluControllerPtr->aluOpAddi = ALU_OP_SIG_OFF;
...
void ALUControllerSetSignals(ALUController* aluControllerPtr)
{
    if ((aluControllerPtr->controlRegister & ALU_OP_ADDI_BITMASK) != 0) aluControllerPtr->aluOpAddi = ALU_OP_SIG_ON;
...
void ALUControllerPrintControlRegister(ALUController* aluControllerPtr)
{
    if (printAluControllerSignals == PRINT_ALU_CONTROLLER_SIGNALS)
    {
        ...
        controlRegisterSignal = aluControllerPtr->controlRegister & ALU_OP_ADDI_BITMASK;
